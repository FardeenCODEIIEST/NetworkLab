...
#define destination_ip "10.2.78.90"
...
void get_eth_index()
{
	...
	strncpy(ifreq_i.ifr_name, "enp2s0", IFNAMSIZ - 1);
...
void get_mac()
{
	...
	strncpy(ifreq_c.ifr_name, "enp2s0", IFNAMSIZ - 1);
...
void get_ip()
{
	...
	strncpy(ifreq_ip.ifr_name, "enp2s0", IFNAMSIZ - 1);
